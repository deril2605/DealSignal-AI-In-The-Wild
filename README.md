...
- `Dockerfile`: packages the pipeline as a job container
...
- `deploy.sh`: provisions Azure resources, pushes the image, and creates the scheduled job
...
Export these in your shell before running `deploy.sh`.  
